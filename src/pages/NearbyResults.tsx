    ...
    <>
      {status === "idle" && (
        <div className="relative bg-white border border-border rounded-2xl p-8 text-center">
          ...
          <p className="text-muted-foreground font-body text-sm mb-6 max-w-2xl mx-auto">Каждая сохраненная Вами закладка сделает быстрый ответ на вопрос "Что посетить сегодня?" точнее, а времяпрепровождение - интереснее.</p>
          <button
            onClick={onFind}
