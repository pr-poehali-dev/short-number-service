      ...
      {status === "idle" && (
        <div className="relative bg-white border border-border rounded-2xl p-8 text-center">
          ...
          <div className="max-w-sm mx-auto space-y-3 pt-6">
            <div className="mb-2">
              <h2 className="font-display text-xl font-bold text-foreground mb-1">Настройте свою орбиту</h2>
              <p className="text-sm text-muted-foreground font-body">Кафе, аптеки, банки и другие полезные места — за секунду, что бы знать и успевать больше других</p>
            </div>
            {/* Поиск по геолокации */}
            <button
              onClick={onFind}
