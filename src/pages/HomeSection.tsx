        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={s.label} className="bg-white rounded-xl p-4 shadow-sm border border-border text-center hover-scale">
              {s.icon ? <Icon name={s.icon as IconName} size={22} className="text-primary mx-auto mb-1" /> : <span className="block text-primary font-display text-lg mx-auto mb-1 font-normal">N</span>}
