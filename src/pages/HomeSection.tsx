...
function NumberForm() {
  ...
  return (
    <div className="bg-white border border-border rounded-2xl p-6">
      ...
      <p className="text-sm text-muted-foreground font-body mb-4">Предложите короткий номер, измените описание или поделитесь фото</p>
      ...
      <div className="bg-gradient-to-br from-[#0376BB] to-[#025a90] text-white py-16 px-4 relative">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            ><Icon name="Phone" size={18} />Короткие номера</button>
            <button
            ...
            ><Icon name="Sparkles" size={18} />Быстрые ответы</button>
          </div>
        </div>
