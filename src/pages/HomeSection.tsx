    ...
    <div className="animate-fade-in">
      ...
      <div className="bg-gradient-to-br from-[hsl(var(--primary))] to-blue-700 text-white py-16 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-white/80 font-body mb-8 max-w-xl mx-auto text-lg">Экстренные службы, техподдержка операторов, социальные и коммерческие  сервисы — найдите нужный номер или ответ за секунды</p>
