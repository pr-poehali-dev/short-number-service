...
function CommercialCard({ num, onClick }: { num: PhoneNumber; onClick: (n: PhoneNumber) => void }) {
  return (
    ...
    >
      <div className="w-14 h-14 rounded-xl bg-amber-50 dark:bg-amber-950/40 flex items-center justify-center flex-shrink-0 flex-col gap-0.5">
        <span className="font-display font-bold text-amber-700 dark:text-amber-400 text-sm leading-tight text-center px-1">{num.number}</span>
      </div>
