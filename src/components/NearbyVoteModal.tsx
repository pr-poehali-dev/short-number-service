      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md relative">
        ...
        {step === "vote" && (
          <div className="p-6">
            ...
            <p className="text-sm font-body text-muted-foreground leading-relaxed mb-5">Представьте себе сайт (ярлык на веб-приложение), каждый раз открывая который Вы узнаете, как лучше (именно Вам!), по мнению нейросети, провести свое свободной время в тех местах, где живете, работаете, бываете или планируете побывать. Нужно лишь найти места, которые Вы посещаете или планируете, и сохранить в "Избранное с AI-поиском". Для поиска мест мы планируем использовать коммерческий API 2ГИС, поэтому запустим сервис в первую очередь для тех, кто поддержит наше начинание, оставив свой голос и номер телефона. Как только наберём 1000 голосов, откроем персональный доступ.</p>
            <button
