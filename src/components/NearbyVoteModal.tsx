      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md relative">
        ...
        {step === "vote" && (
          <div className="p-6">
            ...
            <p className="text-sm font-body text-muted-foreground leading-relaxed mb-5">Что, если каждый раз, открывая один сайт, вы получали бы быстрый ответ на вопрос «куда зайти сегодня»? Не рекламу. Не общие советы. Ответ - для вас. Сайт называется «быстрый-ответ.рф». Вы сохраняете места, которые любите или хотите посетить, — нейрогид берёт на себя остальное. А теперь — самое интересное. Владельцы этих мест видят, что их сохранили и начинают работать с аудиторией: запускают акции, присылают спецпредложения, сообщают о новинках..., обучая нейрогида. Сервис будет использовать коммерческий API 2ГИС, поэтому доступ к нему откроется, когда наберём 1000 голосов.</p>
            <button
