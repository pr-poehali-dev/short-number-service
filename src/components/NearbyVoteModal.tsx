      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md relative">
        ...
        {step === "vote" && (
          <div className="p-6">
            ...
            <p className="text-sm font-body text-muted-foreground leading-relaxed mb-5">Что, если каждый раз, открывая сайт "быстрый-ответ.рф", вы сразу получали бы ответ на вопрос «куда зайти сегодня»? Не рекламу. Не общие советы. Ответ - для вас. Вам нужно лишь сохранять в "Избранное" места, которые любите или хотите посетить, — нейрогид берёт на себя остальное. А теперь — самое интересное. Владельцы этих мест будет видеть, что их сохранили и начинут работать с вами, как с целевой аудиторией: запускать акции, присылать спецпредложения, сообщать о новинках..., обучая тем самым вашего нейрогида.</p>
            <button
