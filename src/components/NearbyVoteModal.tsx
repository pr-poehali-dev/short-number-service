      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md relative">
        ...
        {step === "vote" && (
          <div className="p-6">
            ...
            <p className="text-sm font-body text-muted-foreground leading-relaxed mb-5">Что, если каждый раз, открывая сайт "быстрый-ответ.рф", вы получали бы ответ на вопрос «куда зайти сегодня»? Не рекламу и не общие советы, а сразу ответ - для вас. Нужно лишь сохранять в "Избранное" места, которые любите или хотите посетить, а нейрогид возьмет на себя остальное. Теперь — самое интересное. Владельцы этих мест будет видеть, что их сохранили и начинут работать с вами, как с ценной целевой аудиторией: запускать акции, присылать спецпредложения, сообщать о новинках..., обучая тем самым вашего нейрогида. Интересно?</p>
            <button
